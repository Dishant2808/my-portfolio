...
const Footer = () => {
    return (
        <div id='intro' className="mt-4 mb-10 lg:mb-0">
            <div className="flex h-10 items-center justify-center text-xs font-normal text-LightGray py-4 px-2 md:px-4 w-full bg-MidNightBlack border-t border-DarkGray/60">
