...
const Banner = () => {
    return (
        <BannerLayout>
            <div className="absolute inset-0 z-20 flex flex-col items-center py-6 justify-center w-full h-full">
                <div className="bg-white w-[95%] h-[90%] px-4 py-2 rounded-xl overflow-hidden flex md:block border border-DarkGray">
                ...
                <div className="grid grid-cols-2 gap-4 md:gap-0 md:flex items-center justify-between w-full px-4 xl:px-8 2xl:px-16">
                    ...
                    <div className="flex items-center gap-x-1">
                        ...
                        <span className='text-xs text-Snow'>Laravel Projects</span>
                    </div>

                    <div className="flex items-center gap-x-1">
                        <span className='text-base md:text-lg text-Green font-bold'>8+</span>
                        <span className='text-xs text-Snow'>Wordpress Projects</span>
                    </div>
